...
import pl.databazy.jdbc.DealerWindowJDBC;

public class DealerWindowController {


    DealerWindowJDBC jdbc;
    ...
    void modeleDodajModelButtonClicked(MouseEvent event) {
        ...
        modeleMarkaComboBox.getSelectionModel().clearSelection();
